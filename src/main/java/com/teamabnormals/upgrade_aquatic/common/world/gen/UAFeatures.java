...
public class UAFeatures {
	...
	public static final RegistryObject<Feature<TreeFeatureConfig>> RIVER_TREE 				 = FEATURES.register("river_tree", () -> new FeatureRiverTree(TreeFeatureConfig::deserializeFoliage));
}