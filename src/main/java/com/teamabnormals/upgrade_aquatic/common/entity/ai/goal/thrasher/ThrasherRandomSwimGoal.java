...
public class ThrasherRandomSwimGoal extends RandomSwimmingGoal {
	...
	protected Vec3 getPosition() {
		...
		for (int i = 0; vec3d != null && !this.mob.level().getBlockState(BlockPos.containing(vec3d)).isPathfindable(PathComputationType.WATER) && i++ < 10; vec3d = AdvancedRandomPos.findRandomTarget(this.mob, 10, 8, !this.thrasher.getPassengers().isEmpty())) {
		}
