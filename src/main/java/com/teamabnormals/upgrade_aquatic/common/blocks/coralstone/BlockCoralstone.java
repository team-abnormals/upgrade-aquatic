...
public class BlockCoralstone extends Block {
	...
	public BlockCoralstone(Properties properties, boolean chiseled) {
		this(properties, chiseled, null);
	}
	
	public BlockCoralstone(Properties properties, boolean chiseled, @Nullable Block[] growableCoralBlocks) {
		super(properties);
