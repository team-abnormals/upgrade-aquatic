...
public class EntityUABoat extends BoatEntity {
	...
	public EntityUABoat(EntityType<? extends BoatEntity> type, World world) {
		super(type, world);
	...
	protected void registerData() {
		...
		this.dataManager.register(BOAT_TYPE, Type.DRIFTWOOD.ordinal());
        ...
        if (!this.isPassenger()) {
            if (onGroundIn) {
                if (this.fallDistance > 3.0F) {
                    if (this.status != EntityUABoat.Status.ON_LAND) {
