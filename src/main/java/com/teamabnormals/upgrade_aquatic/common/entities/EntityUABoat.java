...
public class EntityUABoat extends BoatEntity {
   private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.VARINT);
   private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.FLOAT);
   private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.VARINT);
   private static final DataParameter<Boolean> field_199704_e = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> field_199705_f = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(EntityUABoat.class, DataSerializers.VARINT);
   ...
   public EntityUABoat(EntityType<? extends EntityUABoat> p_i50129_1_, World p_i50129_2_) {
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, EntityUABoat.Type.DRIFTWOOD.ordinal());
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoatType(EntityUABoat.Type.getTypeFromString(compound.getString("Type")));
      }
   ...
   public void setBoatType(EntityUABoat.Type boatType) {
      this.dataManager.set(BOAT_TYPE, boatType.ordinal());
   }

   public EntityUABoat.Type getBoatModel() {
      return EntityUABoat.Type.byId(this.dataManager.get(BOAT_TYPE));
   }
   ...
   public static enum Type {
       ...
       */
      public static EntityUABoat.Type byId(int id) {
    	  EntityUABoat.Type[] aboatentity$type = values();
      ...
      public static EntityUABoat.Type getTypeFromString(String nameIn) {
    	  EntityUABoat.Type[] aboatentity$type = values();
