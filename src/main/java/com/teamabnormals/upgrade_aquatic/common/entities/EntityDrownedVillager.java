 ...
 * MAJOR WIP
 */
public class EntityDrownedVillager extends EntityZombie implements IRangedAttackMob {
    ...
    public boolean isTargetingUnderwater() {
    	if (this.targetingUnderwater) {
            ...
            EntityLivingBase livingEntity_1 = this.getAttackTarget();
    ...
    public boolean method_7012(@Nullable EntityLivingBase livingEntity_1) {
	...
	@Override
	public void attackEntityWithRangedAttack(EntityLivingBase arg0, float arg1) {
	...
	static class EntityAIDrownedMoveHelper extends EntityMoveHelper {
		...
		public void tick() {
            EntityLivingBase livingEntity_1 = this.drowned.getAttackTarget();
