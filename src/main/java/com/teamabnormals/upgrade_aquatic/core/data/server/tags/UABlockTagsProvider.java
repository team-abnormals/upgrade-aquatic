...
public class UABlockTagsProvider extends BlockTagsProvider {
	...
	protected void addTags() {
		...
		for (RegistryObject<Block> block : HELPER.getDeferredRegister().getEntries()) {
			...
			if (path.contains("luminous_prismarine") || path.contains("luminous_elder_prismarine") || (path.contains("dead") && path.contains("coral")) || path.contains("tooth") || path.contains("scute") || path.contains("coralstone") || path.contains("kelpy_cobblestone") || path.contains("kelpy_stone")) {
