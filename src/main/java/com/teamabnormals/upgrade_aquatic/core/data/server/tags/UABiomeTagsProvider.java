...
public class UABiomeTagsProvider extends BiomeTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(UABiomeTags.HAS_EXTRA_DRIFTWOOD).addOptional(ResourceLocation.fromNamespaceAndPath("atmospheric", "rainforest_basin")).addOptional(ResourceLocation.fromNamespaceAndPath("atmospheric", "sparse_rainforest_basin"));
