...
public class UASoundEvents {
	...
	public static final RegistryObject<SoundEvent> PIKE_AMBIENT = HELPER.createSoundEvent("entity.pike.ambient");
	public static final RegistryObject<SoundEvent> PIKE_DEATH = HELPER.createSoundEvent("entity.pike.death");
	public static final RegistryObject<SoundEvent> PIKE_HURT = HELPER.createSoundEvent("entity.pike.hurt");
	public static final RegistryObject<SoundEvent> PIKE_FLOP = HELPER.createSoundEvent("entity.pike.flop");
	public static final RegistryObject<SoundEvent> PIKE_BITE = HELPER.createSoundEvent("entity.pike.bite");
	public static final RegistryObject<SoundEvent> PIKE_SPIT = HELPER.createSoundEvent("entity.pike.spit");

	public static final RegistryObject<SoundEvent> PERCH_AMBIENT = HELPER.createSoundEvent("entity.perch.ambient");
	public static final RegistryObject<SoundEvent> PERCH_DEATH = HELPER.createSoundEvent("entity.perch.death");
	public static final RegistryObject<SoundEvent> PERCH_HURT = HELPER.createSoundEvent("entity.perch.hurt");
	public static final RegistryObject<SoundEvent> PERCH_FLOP = HELPER.createSoundEvent("entity.perch.flop");
	...
	public static final RegistryObject<SoundEvent> BUCKET_EMPTY_JELLYFISH = HELPER.createSoundEvent("item.bucket.empty_jellyfish");
	public static final RegistryObject<SoundEvent> BUCKET_FILL_JELLYFISH = HELPER.createSoundEvent("item.bucket.fill_jellyfish");
