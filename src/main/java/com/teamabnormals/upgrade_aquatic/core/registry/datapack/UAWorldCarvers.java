...
public class UAWorldCarvers {
	...
	public static final DeferredHolder<WorldCarver<?>, WorldCarver<UnderwaterCanyonCarverConfiguration>> UNDERWATER_CANYON = WORLD_CARVERS.register("underwater_canyon", () -> new UnderwaterCanyonWorldCarver(UnderwaterCanyonCarverConfiguration.CODEC));
