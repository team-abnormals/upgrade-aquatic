...
public class UAItems {
	...
	public static final DeferredItem<Item> ELDER_EYE = HELPER.createItem("elder_eye", () -> new ElderEyeBlockItem(UABlocks.ELDER_EYE.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> BOILED_PICKERELWEED = HELPER.createItem("boiled_pickerelweed", () -> new BoiledPickerelweedItem(new Item.Properties().food(UAFoods.PICKERELWEED)));

	public static final DeferredItem<Item> PIKE = HELPER.createItem("pike", () -> new Item(new Item.Properties().food(UAFoods.PIKE)));
	public static final DeferredItem<Item> COOKED_PIKE = HELPER.createItem("cooked_pike", () -> new Item(new Item.Properties().food(UAFoods.COOKED_PIKE)));
	public static final DeferredItem<Item> LIONFISH = HELPER.createItem("lionfish", () -> new Item(new Item.Properties().food(UAFoods.LIONFISH)));
	public static final DeferredItem<Item> COOKED_LIONFISH = HELPER.createItem("cooked_lionfish", () -> new Item(new Item.Properties().food(UAFoods.COOKED_LIONFISH)));
	public static final DeferredItem<Item> PERCH = HELPER.createItem("perch", () -> new Item(new Item.Properties().food(UAFoods.PERCH)));
	public static final DeferredItem<Item> COOKED_PERCH = HELPER.createItem("cooked_perch", () -> new Item(new Item.Properties().food(UAFoods.COOKED_PERCH)));

	public static final DeferredItem<Item> MULBERRY = HELPER.createItem("mulberry", () -> new ItemNameBlockItem(UABlocks.MULBERRY_VINE.get(), new Item.Properties().food(UAFoods.MULBERRY)));
	public static final DeferredItem<Item> MULBERRY_JAM_BOTTLE = HELPER.createItem("mulberry_jam_bottle", () -> new MulberryJamBottleItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE).food(UAFoods.MULBERRY_JAM)));
	public static final DeferredItem<Item> MULBERRY_BREAD = HELPER.createItem("mulberry_bread", () -> new Item(new Item.Properties().food(UAFoods.MULBERRY_BREAD)));
	public static final DeferredItem<Item> MULBERRY_PIE = HELPER.createItem("mulberry_pie", () -> new Item(new Item.Properties().food(UAFoods.MULBERRY_PIE)));

	public static final DeferredItem<Item> MUSIC_DISC_ATLANTIS = HELPER.createItem("music_disc_atlantis", () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(UAJukeboxSongs.JUKEBOX_SONG_ATLANTIS)));
	public static final DeferredItem<Item> DISC_FRAGMENT_ATLANTIS = HELPER.createItem("disc_fragment_atlantis", () -> new DiscFragmentItem(new Item.Properties()));

	public static final DeferredItem<Item> PREDATOR_POTTERY_SHERD = HELPER.createItem("predator_pottery_sherd", () -> new Item(new Item.Properties()));

	public static final DeferredItem<DeferredSpawnEggItem> NAUTILUS_SPAWN_EGG = HELPER.createSpawnEggItem("nautilus", UAEntityTypes.NAUTILUS::get, 14596231, 16744272);
	public static final DeferredItem<DeferredSpawnEggItem> PIKE_SPAWN_EGG = HELPER.createSpawnEggItem("pike", UAEntityTypes.PIKE::get, 4806944, 13002040);
	public static final DeferredItem<DeferredSpawnEggItem> LIONFISH_SPAWN_EGG = HELPER.createSpawnEggItem("lionfish", UAEntityTypes.LIONFISH::get, 15281931, 16111310);
	public static final DeferredItem<DeferredSpawnEggItem> PERCH_SPAWN_EGG = HELPER.createSpawnEggItem("perch", UAEntityTypes.PERCH::get, 7764021, 12555079);
	public static final DeferredItem<DeferredSpawnEggItem> THRASHER_SPAWN_EGG = HELPER.createSpawnEggItem("thrasher", UAEntityTypes.THRASHER::get, 7255507, 11730927);
	public static final DeferredItem<DeferredSpawnEggItem> GREAT_THRASHER_SPAWN_EGG = HELPER.createSpawnEggItem("great_thrasher", UAEntityTypes.GREAT_THRASHER::get, 10078409, 13294289);
	public static final DeferredItem<DeferredSpawnEggItem> FLARE_SPAWN_EGG = HELPER.createSpawnEggItem("flare", UAEntityTypes.FLARE::get, 4532619, 14494960);
	public static final DeferredItem<JellyfishSpawnEggItem> JELLYFISH_SPAWN_EGG = HELPER.createJellyfishSpawnEggItem("jellyfish", 3911164, 16019855);
	public static final DeferredItem<DeferredSpawnEggItem> GOOSE_SPAWN_EGG = HELPER.createSpawnEggItem("goose", UAEntityTypes.GOOSE::get, 16448255, 16751914);
