...
public class UAItems {
	...
	public static void onRegisterItems(RegistryEvent.Register<Item> event) {
		final Item[] items = {
			NAUTILUS_BUCKET, PIKE_BUCKET, LIONFISH_BUCKET, PRISMARINE_ROD, BOILED_PICKERELWEED_BLUE, BOILED_PICKERELWEED_PURPLE, PIKE, PIKE_COOKED, LIONFISH, LIONFISH_COOKED
		};
