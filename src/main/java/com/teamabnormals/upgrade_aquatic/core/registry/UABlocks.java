...
public class UABlocks {
	...
	public static final DeferredBlock<Block> PICKERELWEED_BLOCK = HELPER.createBlock("pickerelweed_block", () -> new PickerelweedBlock(UAProperties.createPickerelweedBlock(false), false));
	public static final DeferredBlock<Block> BOILED_PICKERELWEED_BLOCK = HELPER.createBlock("boiled_pickerelweed_block", () -> new PickerelweedBlock(UAProperties.createPickerelweedBlock(true), true));

	public static final DeferredBlock<Block> POTTED_WHITE_SEAROCKET = HELPER.createBlockNoItem("potted_white_searocket", () -> new FlowerPotBlock(WHITE_SEAROCKET.get(), PropertyUtil.flowerPot()));
	...
	public static final DeferredBlock<Block> ORANGE_BEDROLL = HELPER.createBlock("orange_bedroll", createBedroll(DyeColor.ORANGE));
	public static final DeferredBlock<Block> MAGENTA_BEDROLL = HELPER.createBlock("magenta_bedroll", createBedroll(DyeColor.MAGENTA));
	public static final DeferredBlock<Block> LIGHT_BLUE_BEDROLL = HELPER.createBlock("light_blue_bedroll", createBedroll(DyeColor.LIGHT_BLUE));
	public static final DeferredBlock<Block> YELLOW_BEDROLL = HELPER.createBlock("yellow_bedroll", createBedroll(DyeColor.YELLOW));
	public static final DeferredBlock<Block> LIME_BEDROLL = HELPER.createBlock("lime_bedroll", createBedroll(DyeColor.LIME));
	public static final DeferredBlock<Block> PINK_BEDROLL = HELPER.createBlock("pink_bedroll", createBedroll(DyeColor.PINK));
	public static final DeferredBlock<Block> GRAY_BEDROLL = HELPER.createBlock("gray_bedroll", createBedroll(DyeColor.GRAY));
	public static final DeferredBlock<Block> LIGHT_GRAY_BEDROLL = HELPER.createBlock("light_gray_bedroll", createBedroll(DyeColor.LIGHT_GRAY));
	public static final DeferredBlock<Block> CYAN_BEDROLL = HELPER.createBlock("cyan_bedroll", createBedroll(DyeColor.CYAN));
	public static final DeferredBlock<Block> PURPLE_BEDROLL = HELPER.createBlock("purple_bedroll", createBedroll(DyeColor.PURPLE));
	public static final DeferredBlock<Block> BLUE_BEDROLL = HELPER.createBlock("blue_bedroll", createBedroll(DyeColor.BLUE));
	public static final DeferredBlock<Block> BROWN_BEDROLL = HELPER.createBlock("brown_bedroll", createBedroll(DyeColor.BROWN));
	public static final DeferredBlock<Block> GREEN_BEDROLL = HELPER.createBlock("green_bedroll", createBedroll(DyeColor.GREEN));
	...
	public static final DeferredBlock<Block> DEAD_STAR_CORAL_BLOCK = HELPER.createBlock("dead_star_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL_BLOCK = HELPER.createBlock("dead_moss_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL_BLOCK = HELPER.createBlock("dead_petal_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL_BLOCK = HELPER.createBlock("dead_branch_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL_BLOCK = HELPER.createBlock("dead_rock_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL_BLOCK = HELPER.createBlock("dead_pillow_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_SILK_CORAL_BLOCK = HELPER.createBlock("dead_silk_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL_BLOCK = HELPER.createBlock("dead_chrome_coral_block", () -> new Block(UAProperties.DEAD_CORAL_BLOCK));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_BLOCK = HELPER.createBlock("elder_prismarine_coral_block", () -> new ConduitFrameBlock(UAProperties.createPrismarineCoralBlock(true)));

	public static final DeferredBlock<Block> ACAN_CORAL_BLOCK = HELPER.createBlock("acan_coral_block", () -> new CoralBlock(DEAD_ACAN_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_CYAN)));
	public static final DeferredBlock<Block> FINGER_CORAL_BLOCK = HELPER.createBlock("finger_coral_block", () -> new CoralBlock(DEAD_FINGER_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.TERRACOTTA_ORANGE)));
	public static final DeferredBlock<Block> STAR_CORAL_BLOCK = HELPER.createBlock("star_coral_block", () -> new CoralBlock(DEAD_STAR_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_LIGHT_GREEN)));
	public static final DeferredBlock<Block> MOSS_CORAL_BLOCK = HELPER.createBlock("moss_coral_block", () -> new CoralBlock(DEAD_MOSS_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_GREEN)));
	public static final DeferredBlock<Block> PETAL_CORAL_BLOCK = HELPER.createBlock("petal_coral_block", () -> new CoralBlock(DEAD_PETAL_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_LIGHT_BLUE)));
	public static final DeferredBlock<Block> BRANCH_CORAL_BLOCK = HELPER.createBlock("branch_coral_block", () -> new CoralBlock(DEAD_BRANCH_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> ROCK_CORAL_BLOCK = HELPER.createBlock("rock_coral_block", () -> new CoralBlock(DEAD_ROCK_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_BROWN)));
	public static final DeferredBlock<Block> PILLOW_CORAL_BLOCK = HELPER.createBlock("pillow_coral_block", () -> new CoralBlock(DEAD_PILLOW_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.TERRACOTTA_WHITE)));
	public static final DeferredBlock<Block> SILK_CORAL_BLOCK = HELPER.createBlock("silk_coral_block", () -> new CoralBlock(DEAD_SILK_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.COLOR_PURPLE)));
	public static final DeferredBlock<Block> CHROME_CORAL_BLOCK = HELPER.createBlock("chrome_coral_block", () -> new CoralBlock(DEAD_CHROME_CORAL_BLOCK.get(), UAProperties.createCoralBlock(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> PRISMARINE_CORAL_BLOCK = HELPER.createBlock("prismarine_coral_block", () -> new PrismarineCoralBlock(ELDER_PRISMARINE_CORAL_BLOCK.get(), UAProperties.createPrismarineCoralBlock(false)));

	public static final DeferredBlock<Block> DEAD_ACAN_CORAL = HELPER.createBlock("dead_acan_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_FINGER_CORAL = HELPER.createBlock("dead_finger_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_STAR_CORAL = HELPER.createBlock("dead_star_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL = HELPER.createBlock("dead_moss_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL = HELPER.createBlock("dead_petal_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL = HELPER.createBlock("dead_branch_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL = HELPER.createBlock("dead_rock_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL = HELPER.createBlock("dead_pillow_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_SILK_CORAL = HELPER.createBlock("dead_silk_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL = HELPER.createBlock("dead_chrome_coral", () -> new BaseCoralPlantBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL = HELPER.createBlock("elder_prismarine_coral", () -> new BaseCoralPlantBlock(UAProperties.createPrismarineCoral(true)));

	public static final DeferredBlock<Block> ACAN_CORAL = HELPER.createBlock("acan_coral", () -> new CoralPlantBlock(DEAD_ACAN_CORAL.get(), UAProperties.createCoral(MapColor.COLOR_CYAN)));
	public static final DeferredBlock<Block> FINGER_CORAL = HELPER.createBlock("finger_coral", () -> new CoralPlantBlock(DEAD_FINGER_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_ORANGE)));
	public static final DeferredBlock<Block> STAR_CORAL = HELPER.createBlock("star_coral", () -> new CoralPlantBlock(DEAD_STAR_CORAL.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_GREEN)));
	public static final DeferredBlock<Block> MOSS_CORAL = HELPER.createBlock("moss_coral", () -> new CoralPlantBlock(DEAD_MOSS_CORAL.get(), UAProperties.createCoral(MapColor.COLOR_GREEN)));
	public static final DeferredBlock<Block> PETAL_CORAL = HELPER.createBlock("petal_coral", () -> new CoralPlantBlock(DEAD_PETAL_CORAL.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_BLUE)));
	public static final DeferredBlock<Block> BRANCH_CORAL = HELPER.createBlock("branch_coral", () -> new CoralPlantBlock(DEAD_BRANCH_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> ROCK_CORAL = HELPER.createBlock("rock_coral", () -> new CoralPlantBlock(DEAD_ROCK_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_BROWN)));
	public static final DeferredBlock<Block> PILLOW_CORAL = HELPER.createBlock("pillow_coral", () -> new CoralPlantBlock(DEAD_PILLOW_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_WHITE)));
	public static final DeferredBlock<Block> SILK_CORAL = HELPER.createBlock("silk_coral", () -> new CoralPlantBlock(DEAD_SILK_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_PURPLE)));
	public static final DeferredBlock<Block> CHROME_CORAL = HELPER.createBlock("chrome_coral", () -> new CoralPlantBlock(DEAD_CHROME_CORAL.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> PRISMARINE_CORAL = HELPER.createBlock("prismarine_coral", () -> new CoralPlantBlock(ELDER_PRISMARINE_CORAL.get(), UAProperties.createPrismarineCoral(false)));

	public static final DeferredBlock<Block> DEAD_ACAN_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_acan_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_FINGER_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_finger_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_STAR_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_star_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_moss_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_petal_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_branch_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_rock_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_pillow_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_SILK_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_silk_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL_WALL_FAN = HELPER.createBlockNoItem("dead_chrome_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_WALL_FAN = HELPER.createBlockNoItem("elder_prismarine_coral_wall_fan", () -> new BaseCoralWallFanBlock(UAProperties.createPrismarineCoral(true)));

	public static final DeferredBlock<Block> ACAN_CORAL_WALL_FAN = HELPER.createBlockNoItem("acan_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_ACAN_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_CYAN)));
	public static final DeferredBlock<Block> FINGER_CORAL_WALL_FAN = HELPER.createBlockNoItem("finger_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_FINGER_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_ORANGE)));
	public static final DeferredBlock<Block> STAR_CORAL_WALL_FAN = HELPER.createBlockNoItem("star_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_STAR_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_GREEN)));
	public static final DeferredBlock<Block> MOSS_CORAL_WALL_FAN = HELPER.createBlockNoItem("moss_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_MOSS_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_GREEN)));
	public static final DeferredBlock<Block> PETAL_CORAL_WALL_FAN = HELPER.createBlockNoItem("petal_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_PETAL_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_BLUE)));
	public static final DeferredBlock<Block> BRANCH_CORAL_WALL_FAN = HELPER.createBlockNoItem("branch_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_BRANCH_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> ROCK_CORAL_WALL_FAN = HELPER.createBlockNoItem("rock_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_ROCK_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_BROWN)));
	public static final DeferredBlock<Block> PILLOW_CORAL_WALL_FAN = HELPER.createBlockNoItem("pillow_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_PILLOW_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_WHITE)));
	public static final DeferredBlock<Block> SILK_CORAL_WALL_FAN = HELPER.createBlockNoItem("silk_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_SILK_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_PURPLE)));
	public static final DeferredBlock<Block> CHROME_CORAL_WALL_FAN = HELPER.createBlockNoItem("chrome_coral_wall_fan", () -> new CoralWallFanBlock(DEAD_CHROME_CORAL_WALL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)));
	public static final DeferredBlock<Block> PRISMARINE_CORAL_WALL_FAN = HELPER.createBlockNoItem("prismarine_coral_wall_fan", () -> new CoralWallFanBlock(ELDER_PRISMARINE_CORAL_WALL_FAN.get(), UAProperties.createPrismarineCoral(false)));

	public static final DeferredBlock<Block> DEAD_ACAN_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_acan_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_ACAN_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_FINGER_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_finger_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_FINGER_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_STAR_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_star_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_STAR_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_moss_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_MOSS_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_petal_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_PETAL_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_branch_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_BRANCH_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_rock_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_ROCK_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_pillow_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_PILLOW_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_SILK_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_silk_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_SILK_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL_FAN = HELPER.createStandingAndWallBlock("dead_chrome_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL_FAN), DEAD_CHROME_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_FAN = HELPER.createStandingAndWallBlock("elder_prismarine_coral_fan", () -> new BaseCoralFanBlock(UAProperties.createPrismarineCoral(true)), ELDER_PRISMARINE_CORAL_WALL_FAN, Direction.DOWN);

	public static final DeferredBlock<Block> ACAN_CORAL_FAN = HELPER.createStandingAndWallBlock("acan_coral_fan", () -> new CoralFanBlock(DEAD_ACAN_CORAL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_CYAN)), ACAN_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> FINGER_CORAL_FAN = HELPER.createStandingAndWallBlock("finger_coral_fan", () -> new CoralFanBlock(DEAD_FINGER_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_ORANGE)), FINGER_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> STAR_CORAL_FAN = HELPER.createStandingAndWallBlock("star_coral_fan", () -> new CoralFanBlock(DEAD_STAR_CORAL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_GREEN)), STAR_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> MOSS_CORAL_FAN = HELPER.createStandingAndWallBlock("moss_coral_fan", () -> new CoralFanBlock(DEAD_MOSS_CORAL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_GREEN)), MOSS_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> PETAL_CORAL_FAN = HELPER.createStandingAndWallBlock("petal_coral_fan", () -> new CoralFanBlock(DEAD_PETAL_CORAL_FAN.get(), UAProperties.createCoral(MapColor.COLOR_LIGHT_BLUE)), PETAL_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> BRANCH_CORAL_FAN = HELPER.createStandingAndWallBlock("branch_coral_fan", () -> new CoralFanBlock(DEAD_BRANCH_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)), BRANCH_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> ROCK_CORAL_FAN = HELPER.createStandingAndWallBlock("rock_coral_fan", () -> new CoralFanBlock(DEAD_ROCK_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_BROWN)), ROCK_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> PILLOW_CORAL_FAN = HELPER.createStandingAndWallBlock("pillow_coral_fan", () -> new CoralFanBlock(DEAD_PILLOW_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_WHITE)), PILLOW_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> SILK_CORAL_FAN = HELPER.createStandingAndWallBlock("silk_coral_fan", () -> new CoralFanBlock(DEAD_SILK_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_PURPLE)), SILK_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> CHROME_CORAL_FAN = HELPER.createStandingAndWallBlock("chrome_coral_fan", () -> new CoralFanBlock(DEAD_CHROME_CORAL_FAN.get(), UAProperties.createCoral(MapColor.TERRACOTTA_GRAY)), CHROME_CORAL_WALL_FAN, Direction.DOWN);
	public static final DeferredBlock<Block> PRISMARINE_CORAL_FAN = HELPER.createStandingAndWallBlock("prismarine_coral_fan", () -> new CoralFanBlock(ELDER_PRISMARINE_CORAL_FAN.get(), UAProperties.createPrismarineCoral(false)), PRISMARINE_CORAL_WALL_FAN, Direction.DOWN);

	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_SHOWER = HELPER.createBlock("elder_prismarine_coral_shower", () -> new DeadCoralShowerBlock(UAProperties.createPrismarineCoral(true)));
	public static final DeferredBlock<Block> PRISMARINE_CORAL_SHOWER = HELPER.createBlock("prismarine_coral_shower", () -> new CoralShowerBlock(ELDER_PRISMARINE_CORAL_SHOWER.get(), UAProperties.createPrismarineCoral(false)));
	...
	public static final DeferredBlock<Block> HORN_CORALSTONE = HELPER.createBlock("horn_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> TUBE_CORALSTONE = HELPER.createBlock("tube_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> BRAIN_CORALSTONE = HELPER.createBlock("brain_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> FIRE_CORALSTONE = HELPER.createBlock("fire_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> ACAN_CORALSTONE = HELPER.createBlock("acan_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> FINGER_CORALSTONE = HELPER.createBlock("finger_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> STAR_CORALSTONE = HELPER.createBlock("star_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> MOSS_CORALSTONE = HELPER.createBlock("moss_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PETAL_CORALSTONE = HELPER.createBlock("petal_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> BRANCH_CORALSTONE = HELPER.createBlock("branch_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> ROCK_CORALSTONE = HELPER.createBlock("rock_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PILLOW_CORALSTONE = HELPER.createBlock("pillow_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> SILK_CORALSTONE = HELPER.createBlock("silk_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> CHROME_CORALSTONE = HELPER.createBlock("chrome_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PRISMARINE_CORALSTONE = HELPER.createBlock("prismarine_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false, new Block[]{PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get()}));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORALSTONE = HELPER.createBlock("elder_prismarine_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false));
	public static final DeferredBlock<Block> DEAD_CORALSTONE = HELPER.createBlock("dead_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, false));

	public static final DeferredBlock<Block> CHISELED_CORALSTONE = HELPER.createBlock("chiseled_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true));
	public static final DeferredBlock<Block> BUBBLE_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_bubble_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> HORN_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_horn_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> TUBE_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_tube_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> BRAIN_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_brain_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> FIRE_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_fire_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> ACAN_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_acan_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> FINGER_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_finger_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> STAR_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_star_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> MOSS_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_moss_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PETAL_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_petal_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> BRANCH_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_branch_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> ROCK_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_rock_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PILLOW_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_pillow_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> SILK_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_silk_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> CHROME_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_chrome_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PRISMARINE_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_prismarine_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true, new Block[]{PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get()}));
	public static final DeferredBlock<Block> CHISELED_ELDER_PRISMARINE_CORALSTONE = HELPER.createBlock("chiseled_elder_prismarine_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true));
	public static final DeferredBlock<Block> DEAD_CHISELED_CORALSTONE = HELPER.createBlock("chiseled_dead_coralstone", () -> new CoralstoneBlock(UAProperties.CORALSTONE, true));

	public static final DeferredBlock<Block> CORALSTONE_SLAB = HELPER.createBlock("coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, null));
	public static final DeferredBlock<Block> BUBBLE_CORALSTONE_SLAB = HELPER.createBlock("bubble_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> HORN_CORALSTONE_SLAB = HELPER.createBlock("horn_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> TUBE_CORALSTONE_SLAB = HELPER.createBlock("tube_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> BRAIN_CORALSTONE_SLAB = HELPER.createBlock("brain_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> FIRE_CORALSTONE_SLAB = HELPER.createBlock("fire_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> ACAN_CORALSTONE_SLAB = HELPER.createBlock("acan_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> FINGER_CORALSTONE_SLAB = HELPER.createBlock("finger_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> STAR_CORALSTONE_SLAB = HELPER.createBlock("star_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> MOSS_CORALSTONE_SLAB = HELPER.createBlock("moss_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PETAL_CORALSTONE_SLAB = HELPER.createBlock("petal_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> BRANCH_CORALSTONE_SLAB = HELPER.createBlock("branch_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> ROCK_CORALSTONE_SLAB = HELPER.createBlock("rock_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PILLOW_CORALSTONE_SLAB = HELPER.createBlock("pillow_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> SILK_CORALSTONE_SLAB = HELPER.createBlock("silk_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> CHROME_CORALSTONE_SLAB = HELPER.createBlock("chrome_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PRISMARINE_CORALSTONE_SLAB = HELPER.createBlock("prismarine_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, new Block[]{PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get()}));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORALSTONE_SLAB = HELPER.createBlock("elder_prismarine_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, null));
	public static final DeferredBlock<Block> DEAD_CORALSTONE_SLAB = HELPER.createBlock("dead_coralstone_slab", () -> new CoralstoneSlabBlock(UAProperties.CORALSTONE, null));

	public static final DeferredBlock<Block> CORALSTONE_STAIRS = HELPER.createBlock("coralstone_stairs", () -> new CoralstoneStairsBlock(() -> CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, null));
	public static final DeferredBlock<Block> BUBBLE_CORALSTONE_STAIRS = HELPER.createBlock("bubble_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> BUBBLE_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> HORN_CORALSTONE_STAIRS = HELPER.createBlock("horn_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> HORN_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> TUBE_CORALSTONE_STAIRS = HELPER.createBlock("tube_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> TUBE_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> BRAIN_CORALSTONE_STAIRS = HELPER.createBlock("brain_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> BRAIN_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> FIRE_CORALSTONE_STAIRS = HELPER.createBlock("fire_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> FIRE_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN}));
	public static final DeferredBlock<Block> ACAN_CORALSTONE_STAIRS = HELPER.createBlock("acan_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> ACAN_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> FINGER_CORALSTONE_STAIRS = HELPER.createBlock("finger_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> FINGER_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> STAR_CORALSTONE_STAIRS = HELPER.createBlock("star_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> STAR_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> MOSS_CORALSTONE_STAIRS = HELPER.createBlock("moss_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> MOSS_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PETAL_CORALSTONE_STAIRS = HELPER.createBlock("petal_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> PETAL_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> BRANCH_CORALSTONE_STAIRS = HELPER.createBlock("branch_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> BRANCH_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> ROCK_CORALSTONE_STAIRS = HELPER.createBlock("rock_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> ROCK_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PILLOW_CORALSTONE_STAIRS = HELPER.createBlock("pillow_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> PILLOW_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> SILK_CORALSTONE_STAIRS = HELPER.createBlock("silk_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> SILK_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> CHROME_CORALSTONE_STAIRS = HELPER.createBlock("chrome_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> CHROME_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get()}));
	public static final DeferredBlock<Block> PRISMARINE_CORALSTONE_STAIRS = HELPER.createBlock("prismarine_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> PRISMARINE_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, new Block[]{PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get()}));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORALSTONE_STAIRS = HELPER.createBlock("elder_prismarine_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> ELDER_PRISMARINE_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, null));
	public static final DeferredBlock<Block> DEAD_CORALSTONE_STAIRS = HELPER.createBlock("dead_coralstone_stairs", () -> new CoralstoneStairsBlock(() -> DEAD_CORALSTONE.get().defaultBlockState(), UAProperties.CORALSTONE, null));

	public static final DeferredBlock<Block> CORALSTONE_WALL = HELPER.createBlock("coralstone_wall", () -> new CoralstoneWallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> BUBBLE_CORALSTONE_WALL = HELPER.createBlock("bubble_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> HORN_CORALSTONE_WALL = HELPER.createBlock("horn_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> TUBE_CORALSTONE_WALL = HELPER.createBlock("tube_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> BRAIN_CORALSTONE_WALL = HELPER.createBlock("brain_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> FIRE_CORALSTONE_WALL = HELPER.createBlock("fire_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> ACAN_CORALSTONE_WALL = HELPER.createBlock("acan_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> FINGER_CORALSTONE_WALL = HELPER.createBlock("finger_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> STAR_CORALSTONE_WALL = HELPER.createBlock("star_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> MOSS_CORALSTONE_WALL = HELPER.createBlock("moss_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> PETAL_CORALSTONE_WALL = HELPER.createBlock("petal_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> BRANCH_CORALSTONE_WALL = HELPER.createBlock("branch_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> ROCK_CORALSTONE_WALL = HELPER.createBlock("rock_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> PILLOW_CORALSTONE_WALL = HELPER.createBlock("pillow_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> SILK_CORALSTONE_WALL = HELPER.createBlock("silk_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> CHROME_CORALSTONE_WALL = HELPER.createBlock("chrome_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
	public static final DeferredBlock<Block> PRISMARINE_CORALSTONE_WALL = HELPER.createBlock("prismarine_coralstone_wall", () -> new WallBlock(UAProperties.CORALSTONE));
