...
public class UABlocks {
	...
	public static RegistryObject<Block> ACAN_CORAL_BLOCK              = RegistryUtils.createBlock("acan_coral_block", () -> new BlockUACoralBlock(DEAD_ACAN_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.CYAN)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> FINGER_CORAL_BLOCK            = RegistryUtils.createBlock("finger_coral_block", () -> new BlockUACoralBlock(DEAD_FINGER_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.ORANGE_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> STAR_CORAL_BLOCK              = RegistryUtils.createBlock("star_coral_block", () -> new BlockUACoralBlock(DEAD_STAR_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.LIME)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> MOSS_CORAL_BLOCK              = RegistryUtils.createBlock("moss_coral_block", () -> new BlockUACoralBlock(DEAD_MOSS_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.GREEN)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> PETAL_CORAL_BLOCK             = RegistryUtils.createBlock("petal_coral_block", () -> new BlockUACoralBlock(DEAD_PETAL_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.LIGHT_BLUE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> BRANCH_CORAL_BLOCK            = RegistryUtils.createBlock("branch_coral_block", () -> new BlockUACoralBlock(DEAD_BRANCH_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.GRAY_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> ROCK_CORAL_BLOCK              = RegistryUtils.createBlock("rock_coral_block", () -> new BlockUACoralBlock(DEAD_ROCK_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.BROWN)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> PILLOW_CORAL_BLOCK            = RegistryUtils.createBlock("pillow_coral_block", () -> new BlockUACoralBlock(DEAD_PILLOW_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.WHITE_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> SILK_CORAL_BLOCK              = RegistryUtils.createBlock("silk_coral_block", () -> new BlockUACoralBlock(DEAD_SILK_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.PURPLE)), ItemGroup.BUILDING_BLOCKS);
    ...
    public static RegistryObject<Block> POTTED_SEAROCKET_WHITE 	      = RegistryUtils.createBlockNoItem("potted_searocket_white", () -> new FlowerPotBlock(SEAROCKET_WHITE.get(), Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F)));
    public static RegistryObject<Block> POTTED_SEAROCKET_PINK 	      = RegistryUtils.createBlockNoItem("potted_searocket_pink", () -> new FlowerPotBlock(SEAROCKET_PINK.get(), Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F)));
	...
	public static RegistryObject<Block> THORNY_KELPY_STONE_BRICK      = RegistryUtils.createBlock("thorny_kelpy_stone_brick", () -> new Block(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> OCHRE_KELPY_STONE_BRICK       = RegistryUtils.createBlock("ochre_kelpy_stone_brick", () -> new Block(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> POLAR_KELPY_STONE_BRICK       = RegistryUtils.createBlock("polar_kelpy_stone_brick", () -> new Block(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	
	public static RegistryObject<Block> KELPY_STONE_BRICK_STAIRS         = RegistryUtils.createBlock("kelpy_stone_brick_stairs", () -> new StairsBlock(KELPY_STONE_BRICK.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> TONGUE_KELPY_STONE_BRICK_STAIRS  = RegistryUtils.createBlock("tongue_kelpy_stone_brick_stairs", () -> new StairsBlock(TONGUE_KELPY_STONE_BRICK.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> THORNY_KELPY_STONE_BRICK_STAIRS  = RegistryUtils.createBlock("thorny_kelpy_stone_brick_stairs", () -> new StairsBlock(THORNY_KELPY_STONE_BRICK.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> OCHRE_KELPY_STONE_BRICK_STAIRS   = RegistryUtils.createBlock("ochre_kelpy_stone_brick_stairs", () -> new StairsBlock(OCHRE_KELPY_STONE_BRICK.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static RegistryObject<Block> POLAR_KELPY_STONE_BRICK_STAIRS   = RegistryUtils.createBlock("polar_kelpy_stone_brick_stairs", () -> new StairsBlock(POLAR_KELPY_STONE_BRICK.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	...
	static {
		CORALSTONE_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CORALSTONE.get());
		CORALSTONE_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CHISELED_CORALSTONE.get());
		CHISELED_CORALSTONE_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CHISELED_CORALSTONE.get());
		
		CORALSTONE_SLAB_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CORALSTONE_SLAB.get());
		CORALSTONE_SLAB_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CORALSTONE_SLAB.get());
		
		CORALSTONE_STAIRS_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CORALSTONE_STAIRS.get());
		CORALSTONE_STAIRS_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CORALSTONE_STAIRS.get());
		
		CORALSTONE_WALL_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CORALSTONE_WALL.get());
		CORALSTONE_WALL_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CORALSTONE_WALL.get());
		
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(Blocks.BUBBLE_CORAL_BLOCK, BUBBLE_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(Blocks.HORN_CORAL_BLOCK, HORN_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(Blocks.TUBE_CORAL_BLOCK, TUBE_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(Blocks.BRAIN_CORAL_BLOCK, BRAIN_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(Blocks.FIRE_CORAL_BLOCK, FIRE_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(ACAN_CORAL_BLOCK.get(), ACAN_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(FINGER_CORAL_BLOCK.get(), FINGER_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(STAR_CORAL_BLOCK.get(), STAR_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(MOSS_CORAL_BLOCK.get(), MOSS_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(PETAL_CORAL_BLOCK.get(), PETAL_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(BRANCH_CORAL_BLOCK.get(), BRANCH_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(ROCK_CORAL_BLOCK.get(), ROCK_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(PILLOW_CORAL_BLOCK.get(), PILLOW_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(SILK_CORAL_BLOCK.get(), SILK_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(CHROME_CORAL_BLOCK.get(), CHROME_CORALSTONE_VERTICAL_SLAB.get());
		CORALSTONE_VERTICAL_SLAB_CONVERSION_MAP.put(PRISMARINE_CORAL_BLOCK.get(), PRISMARINE_CORALSTONE_VERTICAL_SLAB.get());
	}
