...
public class UABlocks {
	...
	public static RegistryObject<Block> PRISMARINE_CORAL_BLOCK        = RegistryUtils.createBlock("prismarine_coral_block", () -> new CoralBlock(ELDER_PRISMARINE_CORAL_BLOCK.get(), UAProperties.PRISMARINE_CORAL_BLOCK_BASE(false).lightValue(3)), ItemGroup.BUILDING_BLOCKS);
	 ...
	 * Quark Compat
	 */
	public static RegistryObject<Block> DRIFTWOOD_VERTICAL_PLANKS               = RegistryUtils.createCompatBlock("driftwood_vertical_planks", "quark", () -> new Block(UAProperties.DRIFTWOOD), ItemGroup.BUILDING_BLOCKS);
	...
	public static RegistryObject<Block> DRIFTWOOD_LADDER                        = RegistryUtils.createCompatBlock("driftwood_ladder", "quark", () -> new LadderBlock(Properties.from(Blocks.LADDER)), ItemGroup.DECORATIONS);
