...
public class UABlocks {
    ...
    public static RegistryObject<Block> MULBERRY_VINE	= RegistryUtils.createBlockNoItem("mulberry_vine", () -> new BlockMulberryVine(Block.Properties.from(Blocks.SWEET_BERRY_BUSH).notSolid()));
