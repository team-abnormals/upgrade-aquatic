...
public class UABlocks {
	...
	public static final DeferredBlock<Block> DEAD_ACAN_CORAL_FAN = BLOCKS.createBlockNoItem("dead_acan_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_FINGER_CORAL_FAN = BLOCKS.createBlockNoItem("dead_finger_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_STAR_CORAL_FAN = BLOCKS.createBlockNoItem("dead_star_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL_FAN = BLOCKS.createBlockNoItem("dead_moss_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL_FAN = BLOCKS.createBlockNoItem("dead_petal_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL_FAN = BLOCKS.createBlockNoItem("dead_branch_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL_FAN = BLOCKS.createBlockNoItem("dead_rock_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL_FAN = BLOCKS.createBlockNoItem("dead_pillow_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_SILK_CORAL_FAN = BLOCKS.createBlockNoItem("dead_silk_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL_FAN = BLOCKS.createBlockNoItem("dead_chrome_coral_fan", () -> new BaseCoralFanBlock(UAProperties.DEAD_CORAL));
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_FAN = BLOCKS.createBlockNoItem("elder_prismarine_coral_fan", () -> new BaseCoralFanBlock(UAProperties.createPrismarineCoral(true)));

	public static final DeferredBlock<Block> DEAD_ACAN_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_acan_coral_wall_fan", DEAD_ACAN_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_ACAN_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_FINGER_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_finger_coral_wall_fan", DEAD_FINGER_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_FINGER_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_STAR_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_star_coral_wall_fan", DEAD_STAR_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_STAR_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_MOSS_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_moss_coral_wall_fan", DEAD_MOSS_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_MOSS_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_PETAL_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_petal_coral_wall_fan", DEAD_PETAL_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_PETAL_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_BRANCH_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_branch_coral_wall_fan", DEAD_BRANCH_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_BRANCH_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_ROCK_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_rock_coral_wall_fan", DEAD_ROCK_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_ROCK_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_PILLOW_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_pillow_coral_wall_fan", DEAD_PILLOW_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_PILLOW_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_SILK_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_silk_coral_wall_fan", DEAD_SILK_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_SILK_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> DEAD_CHROME_CORAL_WALL_FAN = BLOCKS.createWallBlock("dead_chrome_coral_wall_fan", DEAD_CHROME_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.deadCoralWallFan(() -> DEAD_CHROME_CORAL_FAN.get())), Direction.DOWN);
	public static final DeferredBlock<Block> ELDER_PRISMARINE_CORAL_WALL_FAN = BLOCKS.createWallBlock("elder_prismarine_coral_wall_fan", ELDER_PRISMARINE_CORAL_FAN, () -> new BaseCoralWallFanBlock(UAProperties.createPrismarineCoral(true).lootFrom(() -> ELDER_PRISMARINE_CORAL_FAN.get())), Direction.DOWN);
