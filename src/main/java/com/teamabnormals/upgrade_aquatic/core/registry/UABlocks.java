...
public class UABlocks {
	...
	public static Block ELDER_BIOROCK                 = new BlockBiorock(UAProperties.BIOROCK, false, new Block[] {ELDER_PRISMARINE_CORAL, ELDER_PRISMARINE_CORAL_FAN, ELDER_PRISMARINE_CORAL_WALL_FAN, ELDER_PRISMARINE_CORAL_SHOWER}).setRegistryName(Reference.MODID, "elder_biorock");
	...
	public static Block ELDER_CHISELED_BIOROCK        = new BlockBiorock(UAProperties.BIOROCK, true, new Block[] {ELDER_PRISMARINE_CORAL, ELDER_PRISMARINE_CORAL_FAN, ELDER_PRISMARINE_CORAL_WALL_FAN, ELDER_PRISMARINE_CORAL_SHOWER}).setRegistryName(Reference.MODID, "elder_chiseled_biorock");
	...
	public static Block ELDER_BIOROCK_SLAB            = new BlockBiorockSlab(UAProperties.BIOROCK, new Block[] {ELDER_PRISMARINE_CORAL, ELDER_PRISMARINE_CORAL_FAN, ELDER_PRISMARINE_CORAL_WALL_FAN, ELDER_PRISMARINE_CORAL_SHOWER}).setRegistryName(Reference.MODID, "elder_biorock_slab");
	...
	public static Block FIRE_BIOROCK_STAIRS           = new StairsBlock(FIRE_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "fire_biorock_stairs");
	public static Block ACAN_BIOROCK_STAIRS           = new StairsBlock(ACAN_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "acan_biorock_stairs");
	public static Block FINGER_BIOROCK_STAIRS         = new StairsBlock(FINGER_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "finger_biorock_stairs");
	public static Block STAR_BIOROCK_STAIRS           = new StairsBlock(STAR_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "star_biorock_stairs");
	public static Block MOSS_BIOROCK_STAIRS           = new StairsBlock(MOSS_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "moss_biorock_stairs");
	public static Block PETAL_BIOROCK_STAIRS          = new StairsBlock(PETAL_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "petal_biorock_stairs");
	public static Block BRANCH_BIOROCK_STAIRS         = new StairsBlock(BRANCH_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "branch_biorock_stairs");
	public static Block ROCK_BIOROCK_STAIRS           = new StairsBlock(ROCK_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "rock_biorock_stairs");
	public static Block PILLOW_BIOROCK_STAIRS         = new StairsBlock(PILLOW_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "pillow_biorock_stairs");
	public static Block SILK_BIOROCK_STAIRS           = new StairsBlock(SILK_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "silk_biorock_stairs");
	public static Block PRISMARINE_BIOROCK_STAIRS     = new StairsBlock(PRISMARINE_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "prismarine_biorock_stairs");
	public static Block ELDER_BIOROCK_STAIRS          = new StairsBlock(ELDER_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "elder_biorock_stairs");
	public static Block DEAD_BIOROCK_STAIRS           = new StairsBlock(DEAD_BIOROCK.getDefaultState(), UAProperties.BIOROCK).setRegistryName(Reference.MODID, "dead_biorock_stairs");
