...
public class UABlocks {
	...
	public static Block ACAN_BIOROCK_STAIRS           = new BlockBiorockStairs(() -> ACAN_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.ACAN_CORAL, Blocks.ACAN_CORAL_FAN, Blocks.ACAN_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "acan_biorock_stairs");
	public static Block FINGER_BIOROCK_STAIRS         = new BlockBiorockStairs(() -> FINGER_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.FINGER_CORAL, Blocks.FINGER_CORAL_FAN, Blocks.FINGER_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "finger_biorock_stairs");
	public static Block STAR_BIOROCK_STAIRS           = new BlockBiorockStairs(() -> STAR_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.STAR_CORAL, Blocks.STAR_CORAL_FAN, Blocks.STAR_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "star_biorock_stairs");
	public static Block MOSS_BIOROCK_STAIRS           = new BlockBiorockStairs(() -> MOSS_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.MOSS_CORAL, Blocks.MOSS_CORAL_FAN, Blocks.MOSS_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "moss_biorock_stairs");
	public static Block PETAL_BIOROCK_STAIRS          = new BlockBiorockStairs(() -> PETAL_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.PETAL_CORAL, Blocks.PETAL_CORAL_FAN, Blocks.PETAL_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "petal_biorock_stairs");
	public static Block BRANCH_BIOROCK_STAIRS         = new BlockBiorockStairs(() -> BRANCH_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.BRANCH_CORAL, Blocks.BRANCH_CORAL_FAN, Blocks.BRANCH_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "branch_biorock_stairs");
	public static Block ROCK_BIOROCK_STAIRS           = new BlockBiorockStairs(() -> ROCK_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.ROCK_CORAL, Blocks.ROCK_CORAL_FAN, Blocks.ROCK_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "rock_biorock_stairs");
	public static Block PILLOW_BIOROCK_STAIRS         = new BlockBiorockStairs(() -> PILLOW_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.PILLOW_CORAL, Blocks.PILLOW_CORAL_FAN, Blocks.PILLOW_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "pillow_biorock_stairs");
	public static Block SILK_BIOROCK_STAIRS           = new BlockBiorockStairs(() -> SILK_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.SILK_CORAL, Blocks.SILK_CORAL_FAN, Blocks.SILK_CORAL_WALL_FAN}).setRegistryName(Reference.MODID, "silk_biorock_stairs");
	public static Block PRISMARINE_BIOROCK_STAIRS     = new BlockBiorockStairs(() -> PRISMARINE_BIOROCK.getDefaultState(), UAProperties.BIOROCK, new Block[] {Blocks.PRISMARINE_CORAL, Blocks.PRISMARINE_CORAL_FAN, Blocks.PRISMARINE_CORAL_WALL_FAN, Blocks.PRISMARINE_CORAL_SHOWER}).setRegistryName(Reference.MODID, "prismarine_biorock_stairs");
