...
public class UABlocks {
	...
	public static Block BRAIN_BIOROCK_SLAB            = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "brain_biorock_slab");
	public static Block FIRE_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "fire_biorock_slab");	
	public static Block ACAN_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "acan_biorock_slab");
	public static Block FINGER_BIOROCK_SLAB           = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "finger_biorock_slab");
	public static Block STAR_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "star_biorock_slab");
	public static Block MOSS_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "moss_biorock_slab");
	public static Block PETAL_BIOROCK_SLAB            = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "petal_biorock_slab");
	public static Block BRANCH_BIOROCK_SLAB           = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "branch_biorock_slab");
	public static Block ROCK_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "rock_biorock_slab");
	public static Block PILLOW_BIOROCK_SLAB           = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "pillow_biorock_slab");
	public static Block SILK_BIOROCK_SLAB             = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "silk_biorock_slab");
	public static Block PRISMARINE_BIOROCK_SLAB       = new SlabBlock(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "prismarine_biorock_slab");
    ...
    public static Block BIOROCK_STAIRS                = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "biorock_stairs");
	public static Block BUBBLE_BIOROCK_STAIRS         = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "bubble_biorock_stairs");
	public static Block HORN_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "horn_biorock_stairs");
	public static Block TUBE_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "tube_biorock_stairs");
	public static Block BRAIN_BIOROCK_STAIRS          = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "brain_biorock_stairs");
	public static Block FIRE_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "fire_biorock_stairs");	
	public static Block ACAN_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "acan_biorock_stairs");
	public static Block FINGER_BIOROCK_STAIRS         = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "finger_biorock_stairs");
	public static Block STAR_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "star_biorock_stairs");
	public static Block MOSS_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "moss_biorock_stairs");
	public static Block PETAL_BIOROCK_STAIRS          = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "petal_biorock_stairs");
	public static Block BRANCH_BIOROCK_STAIRS         = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "branch_biorock_stairs");
	public static Block ROCK_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "rock_biorock_stairs");
	public static Block PILLOW_BIOROCK_STAIRS         = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "pillow_biorock_stairs");
	public static Block SILK_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "silk_biorock_stairs");
	public static Block PRISMARINE_BIOROCK_STAIRS     = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "prismarine_biorock_stairs");
	public static Block ELDER_BIOROCK_STAIRS          = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "elder_biorock_stairs");
	public static Block DEAD_BIOROCK_STAIRS           = new BlockStairsBase(Properties.from(Blocks.STONE).harvestTool(ToolType.PICKAXE)).setRegistryName(Reference.MODID, "dead_biorock_stairs");	
