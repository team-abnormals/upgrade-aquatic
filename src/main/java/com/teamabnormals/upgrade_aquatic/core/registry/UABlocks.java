...
public class UABlocks {
	...
	public static final RegistryObject<Block> ELDER_PRISMARINE_CORAL_BLOCK = HELPER.createInjectedBlock("elder_prismarine_coral_block", Blocks.DEAD_HORN_CORAL_BLOCK.asItem(),
			() -> new BlockSupportsConduit(UAProperties.PRISMARINE_CORAL_BLOCK_BASE(true)), ItemGroup.BUILDING_BLOCKS);

	public static final RegistryObject<Block> ACAN_CORAL_BLOCK = HELPER.createInjectedBlock("acan_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(), () -> new CoralBlock(DEAD_ACAN_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.CYAN)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CORAL_BLOCK = HELPER.createInjectedBlock("finger_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new CoralBlock(DEAD_FINGER_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.ORANGE_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CORAL_BLOCK = HELPER.createInjectedBlock("star_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(), () -> new CoralBlock(DEAD_STAR_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.LIME)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CORAL_BLOCK = HELPER.createInjectedBlock("moss_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(), () -> new CoralBlock(DEAD_MOSS_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.GREEN)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CORAL_BLOCK = HELPER.createInjectedBlock("petal_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new CoralBlock(DEAD_PETAL_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.LIGHT_BLUE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CORAL_BLOCK = HELPER.createInjectedBlock("branch_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new CoralBlock(DEAD_BRANCH_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.GRAY_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CORAL_BLOCK = HELPER.createInjectedBlock("rock_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(), () -> new CoralBlock(DEAD_ROCK_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.BROWN)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CORAL_BLOCK = HELPER.createInjectedBlock("pillow_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new CoralBlock(DEAD_PILLOW_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.WHITE_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CORAL_BLOCK = HELPER.createInjectedBlock("silk_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(), () -> new CoralBlock(DEAD_SILK_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.PURPLE)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CORAL_BLOCK = HELPER.createInjectedBlock("chrome_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new CoralBlock(DEAD_CHROME_CORAL_BLOCK.get(), UAProperties.CORAL_BLOCK_BASE(MaterialColor.GRAY_TERRACOTTA)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CORAL_BLOCK = HELPER.createInjectedBlock("prismarine_coral_block", Blocks.HORN_CORAL_BLOCK.asItem(),
			() -> new BlockPrismarineCoralBlock(ELDER_PRISMARINE_CORAL_BLOCK.get(), UAProperties.PRISMARINE_CORAL_BLOCK_BASE(false)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> FINGER_CORAL = HELPER.createInjectedBlock("finger_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_FINGER_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.ORANGE_TERRACOTTA)),
	...
	public static final RegistryObject<Block> PETAL_CORAL = HELPER.createInjectedBlock("petal_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_PETAL_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.LIGHT_BLUE)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> BRANCH_CORAL = HELPER.createInjectedBlock("branch_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_BRANCH_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.GRAY_TERRACOTTA)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> ROCK_CORAL = HELPER.createInjectedBlock("rock_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_ROCK_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.BROWN_TERRACOTTA)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PILLOW_CORAL = HELPER.createInjectedBlock("pillow_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_PILLOW_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.WHITE_TERRACOTTA)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> SILK_CORAL = HELPER.createInjectedBlock("silk_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_SILK_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.PURPLE_TERRACOTTA)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> CHROME_CORAL = HELPER.createInjectedBlock("chrome_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(DEAD_CHROME_CORAL.get(), UAProperties.CORAL_BASE(MaterialColor.GRAY_TERRACOTTA)),
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PRISMARINE_CORAL = HELPER.createInjectedBlock("prismarine_coral", Blocks.HORN_CORAL.asItem(), () -> new BlockUACoral(ELDER_PRISMARINE_CORAL.get(), UAProperties.PRISMARINE_CORAL_BASE(false)),
			ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> ELDER_PRISMARINE_CORAL_FAN = HELPER.createWallOrFloorBlock("elder_prismarine_coral_fan", () -> new BlockUACoralFanDead(UAProperties.PRISMARINE_CORAL_BASE(true)), ELDER_PRISMARINE_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);

	public static final RegistryObject<Block> ACAN_CORAL_FAN = HELPER.createWallOrFloorBlock("acan_coral_fan", () -> new BlockUACoralFan(DEAD_ACAN_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.CYAN)), ACAN_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> FINGER_CORAL_FAN = HELPER.createWallOrFloorBlock("finger_coral_fan", () -> new BlockUACoralFan(DEAD_FINGER_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.ORANGE_TERRACOTTA)),
			FINGER_CORAL_WALL_FAN, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> STAR_CORAL_FAN = HELPER.createWallOrFloorBlock("star_coral_fan", () -> new BlockUACoralFan(DEAD_STAR_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.LIME)), STAR_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> MOSS_CORAL_FAN = HELPER.createWallOrFloorBlock("moss_coral_fan", () -> new BlockUACoralFan(DEAD_MOSS_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.GREEN)), MOSS_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PETAL_CORAL_FAN = HELPER.createWallOrFloorBlock("petal_coral_fan", () -> new BlockUACoralFan(DEAD_PETAL_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.LIGHT_BLUE)), PETAL_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> BRANCH_CORAL_FAN = HELPER.createWallOrFloorBlock("branch_coral_fan", () -> new BlockUACoralFan(DEAD_BRANCH_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.GRAY_TERRACOTTA)),
			BRANCH_CORAL_WALL_FAN, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> ROCK_CORAL_FAN = HELPER.createWallOrFloorBlock("rock_coral_fan", () -> new BlockUACoralFan(DEAD_ROCK_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.BROWN_TERRACOTTA)), ROCK_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PILLOW_CORAL_FAN = HELPER.createWallOrFloorBlock("pillow_coral_fan", () -> new BlockUACoralFan(DEAD_PILLOW_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.WHITE_TERRACOTTA)),
			PILLOW_CORAL_WALL_FAN, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> SILK_CORAL_FAN = HELPER.createWallOrFloorBlock("silk_coral_fan", () -> new BlockUACoralFan(DEAD_SILK_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.PURPLE_TERRACOTTA)), SILK_CORAL_WALL_FAN,
			ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> CHROME_CORAL_FAN = HELPER.createWallOrFloorBlock("chrome_coral_fan", () -> new BlockUACoralFan(DEAD_CHROME_CORAL_FAN.get(), UAProperties.CORAL_FAN_BASE(MaterialColor.GRAY_TERRACOTTA)),
			CHROME_CORAL_WALL_FAN, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PRISMARINE_CORAL_FAN = HELPER.createWallOrFloorBlock("prismarine_coral_fan", () -> new BlockUACoralFan(ELDER_PRISMARINE_CORAL_FAN.get(), UAProperties.PRISMARINE_CORAL_BASE(false)),
			PRISMARINE_CORAL_WALL_FAN, ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> PINK_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_pink", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PINK),
			PINK_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PURPLE_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_purple", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PURPLE),
			PURPLE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> BLUE_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_blue", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.BLUE),
			BLUE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> GREEN_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_green", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.GREEN),
			GREEN_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> YELLOW_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_yellow", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.YELLOW),
			YELLOW_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> ORANGE_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_orange", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.ORANGE),
			ORANGE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> RED_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_red", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.RED),
			RED_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> WHITE_JELLY_TORCH = HELPER.createWallOrFloorBlock("jelly_torch_white", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.WHITE),
			WHITE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> POTTED_BLUE_PICKERELWEED = HELPER.createBlockNoItem("potted_pickerelweed_blue",
			() -> new FlowerPotBlock(BLUE_PICKERELWEED.get(), Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F)));
	public static final RegistryObject<Block> POTTED_PURPLE_PICKERELWEED = HELPER.createBlockNoItem("potted_pickerelweed_purple",
			() -> new FlowerPotBlock(PURPLE_PICKERELWEED.get(), Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F)));
	...
	public static final RegistryObject<Block> TOOTH_LANTERN = HELPER.createBlock("tooth_lantern", () -> new BlockToothLantern(Properties.from(Blocks.END_STONE).sound(UASounds.TOOTH_LANTERN).notSolid().setLightLevel((unknown) -> 15)),
			ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> BUBBLE_CORALSTONE = HELPER.createBlock("bubble_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CORALSTONE = HELPER.createBlock("horn_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CORALSTONE = HELPER.createBlock("tube_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CORALSTONE = HELPER.createBlock("brain_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CORALSTONE = HELPER.createBlock("fire_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CORALSTONE = HELPER.createBlock("acan_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CORALSTONE = HELPER.createBlock("finger_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CORALSTONE = HELPER.createBlock("star_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CORALSTONE = HELPER.createBlock("moss_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CORALSTONE = HELPER.createBlock("petal_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CORALSTONE = HELPER.createBlock("branch_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CORALSTONE = HELPER.createBlock("rock_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CORALSTONE = HELPER.createBlock("pillow_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CORALSTONE = HELPER.createBlock("silk_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CORALSTONE = HELPER.createBlock("chrome_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CORALSTONE = HELPER.createBlock("prismarine_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, false, new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BUBBLE_CHISELED_CORALSTONE = HELPER.createBlock("bubble_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CHISELED_CORALSTONE = HELPER.createBlock("horn_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CHISELED_CORALSTONE = HELPER.createBlock("tube_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CHISELED_CORALSTONE = HELPER.createBlock("brain_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CHISELED_CORALSTONE = HELPER.createBlock("fire_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CHISELED_CORALSTONE = HELPER.createBlock("acan_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CHISELED_CORALSTONE = HELPER.createBlock("finger_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CHISELED_CORALSTONE = HELPER.createBlock("star_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CHISELED_CORALSTONE = HELPER.createBlock("moss_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CHISELED_CORALSTONE = HELPER.createBlock("petal_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CHISELED_CORALSTONE = HELPER.createBlock("branch_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CHISELED_CORALSTONE = HELPER.createBlock("rock_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CHISELED_CORALSTONE = HELPER.createBlock("pillow_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CHISELED_CORALSTONE = HELPER.createBlock("silk_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CHISELED_CORALSTONE = HELPER.createBlock("chrome_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CHISELED_CORALSTONE = HELPER.createBlock("prismarine_chiseled_coralstone",
			() -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BUBBLE_CORALSTONE_SLAB = HELPER.createBlock("bubble_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CORALSTONE_SLAB = HELPER.createBlock("horn_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CORALSTONE_SLAB = HELPER.createBlock("tube_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CORALSTONE_SLAB = HELPER.createBlock("brain_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CORALSTONE_SLAB = HELPER.createBlock("fire_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CORALSTONE_SLAB = HELPER.createBlock("acan_coralstone_slab", () -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CORALSTONE_SLAB = HELPER.createBlock("finger_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CORALSTONE_SLAB = HELPER.createBlock("star_coralstone_slab", () -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CORALSTONE_SLAB = HELPER.createBlock("moss_coralstone_slab", () -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CORALSTONE_SLAB = HELPER.createBlock("petal_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CORALSTONE_SLAB = HELPER.createBlock("branch_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CORALSTONE_SLAB = HELPER.createBlock("rock_coralstone_slab", () -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CORALSTONE_SLAB = HELPER.createBlock("pillow_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CORALSTONE_SLAB = HELPER.createBlock("silk_coralstone_slab", () -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CORALSTONE_SLAB = HELPER.createBlock("chrome_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CORALSTONE_SLAB = HELPER.createBlock("prismarine_coralstone_slab",
			() -> new BlockCoralstoneSlab(UAProperties.CORALSTONE, new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BUBBLE_CORALSTONE_STAIRS = HELPER.createBlock("bubble_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> BUBBLE_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CORALSTONE_STAIRS = HELPER.createBlock("horn_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> HORN_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CORALSTONE_STAIRS = HELPER.createBlock("tube_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> TUBE_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CORALSTONE_STAIRS = HELPER.createBlock("brain_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> BRAIN_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CORALSTONE_STAIRS = HELPER.createBlock("fire_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> FIRE_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CORALSTONE_STAIRS = HELPER.createBlock("acan_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> ACAN_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CORALSTONE_STAIRS = HELPER.createBlock("finger_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> FINGER_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CORALSTONE_STAIRS = HELPER.createBlock("star_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> STAR_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CORALSTONE_STAIRS = HELPER.createBlock("moss_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> MOSS_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CORALSTONE_STAIRS = HELPER.createBlock("petal_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> PETAL_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CORALSTONE_STAIRS = HELPER.createBlock("branch_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> BRANCH_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CORALSTONE_STAIRS = HELPER.createBlock("rock_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> ROCK_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CORALSTONE_STAIRS = HELPER.createBlock("pillow_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> PILLOW_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CORALSTONE_STAIRS = HELPER.createBlock("silk_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> SILK_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CORALSTONE_STAIRS = HELPER.createBlock("chrome_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> CHROME_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CORALSTONE_STAIRS = HELPER.createBlock("prismarine_coralstone_stairs", () -> new BlockCoralstoneStairs(() -> PRISMARINE_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE,
			new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ELDER_PRISMARINE_CORALSTONE_STAIRS = HELPER.createBlock("elder_prismarine_coralstone_stairs",
			() -> new BlockCoralstoneStairs(() -> ELDER_PRISMARINE_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, null), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> DEAD_CORALSTONE_STAIRS = HELPER.createBlock("dead_coralstone_stairs", () -> new BlockCoralstoneStairs(() -> DEAD_CORALSTONE.get().getDefaultState(), UAProperties.CORALSTONE, null),
			ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BUBBLE_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "bubble_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "horn_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "tube_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "brain_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "fire_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "acan_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "finger_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "star_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "moss_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "petal_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "branch_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "rock_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "pillow_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "silk_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "chrome_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "prismarine_coralstone_vertical_slab",
			() -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ELDER_PRISMARINE_CORALSTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "elder_prismarine_coralstone_vertical_slab", () -> new BlockCoralstoneVerticalSlab(UAProperties.CORALSTONE, null),
			ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> KELPY_COBBLESTONE_STAIRS = HELPER.createBlock("kelpy_cobblestone_stairs",
			() -> new AbnormalsStairsBlock(KELPY_COBBLESTONE.get().getDefaultState(), Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TONGUE_KELPY_COBBLESTONE_STAIRS = HELPER.createBlock("tongue_kelpy_cobblestone_stairs",
			() -> new AbnormalsStairsBlock(TONGUE_KELPY_COBBLESTONE.get().getDefaultState(), Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> THORNY_KELPY_COBBLESTONE_STAIRS = HELPER.createBlock("thorny_kelpy_cobblestone_stairs",
			() -> new AbnormalsStairsBlock(THORNY_KELPY_COBBLESTONE.get().getDefaultState(), Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> OCHRE_KELPY_COBBLESTONE_STAIRS = HELPER.createBlock("ochre_kelpy_cobblestone_stairs",
			() -> new AbnormalsStairsBlock(OCHRE_KELPY_COBBLESTONE.get().getDefaultState(), Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> POLAR_KELPY_COBBLESTONE_STAIRS = HELPER.createBlock("polar_kelpy_cobblestone_stairs",
			() -> new AbnormalsStairsBlock(POLAR_KELPY_COBBLESTONE.get().getDefaultState(), Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> KELPY_STONE_BRICK_STAIRS = HELPER.createBlock("kelpy_stone_brick_stairs",
			() -> new AbnormalsStairsBlock(KELPY_STONE_BRICKS.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TONGUE_KELPY_STONE_BRICK_STAIRS = HELPER.createBlock("tongue_kelpy_stone_brick_stairs",
			() -> new AbnormalsStairsBlock(TONGUE_KELPY_STONE_BRICKS.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> THORNY_KELPY_STONE_BRICK_STAIRS = HELPER.createBlock("thorny_kelpy_stone_brick_stairs",
			() -> new AbnormalsStairsBlock(THORNY_KELPY_STONE_BRICKS.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> OCHRE_KELPY_STONE_BRICK_STAIRS = HELPER.createBlock("ochre_kelpy_stone_brick_stairs",
			() -> new AbnormalsStairsBlock(OCHRE_KELPY_STONE_BRICKS.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> POLAR_KELPY_STONE_BRICK_STAIRS = HELPER.createBlock("polar_kelpy_stone_brick_stairs",
			() -> new AbnormalsStairsBlock(POLAR_KELPY_STONE_BRICKS.get().getDefaultState(), Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> KELPY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "kelpy_cobblestone_vertical_slab", () -> new VerticalSlabBlock(Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TONGUE_KELPY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "tongue_kelpy_cobblestone_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> THORNY_KELPY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "thorny_kelpy_cobblestone_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> OCHRE_KELPY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "ochre_kelpy_cobblestone_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> POLAR_KELPY_COBBLESTONE_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "polar_kelpy_cobblestone_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.COBBLESTONE).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);

	public static final RegistryObject<Block> KELPY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "kelpy_stone_brick_vertical_slab", () -> new VerticalSlabBlock(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)),
			ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TONGUE_KELPY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "tongue_kelpy_stone_brick_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> THORNY_KELPY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "thorny_kelpy_stone_brick_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> OCHRE_KELPY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "ochre_kelpy_stone_brick_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> POLAR_KELPY_STONE_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("quark", "polar_kelpy_stone_brick_vertical_slab",
			() -> new VerticalSlabBlock(Properties.from(Blocks.STONE_BRICKS).harvestTool(ToolType.PICKAXE)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> PRISMARINE_ROD_BUNDLE = HELPER.createBlock("prismarine_rod_bundle", () -> new BlockPrismarineRod(Properties.from(Blocks.PRISMARINE_BRICKS).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE)),
			ItemGroup.BUILDING_BLOCKS);
