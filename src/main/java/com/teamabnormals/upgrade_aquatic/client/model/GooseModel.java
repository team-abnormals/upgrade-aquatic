...
public class GooseModel<T extends Entity> extends AgeableListModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftWing = body.addOrReplaceChild("leftWing", CubeListBuilder.create().texOffs(2, 17).addBox(0.0F, -1.0F, 0.0F, 1.0F, 5.0F, 7.0F, false), PartPose.offsetAndRotation(2.0F, 0.0F, -3.0F, 0.0F, 0.0F, 0.0F));
