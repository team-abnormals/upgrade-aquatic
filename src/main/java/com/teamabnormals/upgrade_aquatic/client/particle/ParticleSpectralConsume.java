...
public class ParticleSpectralConsume extends SpriteTexturedParticle {
	...
	public ParticleSpectralConsume(IAnimatedSprite animatedSprite, ClientWorld world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
