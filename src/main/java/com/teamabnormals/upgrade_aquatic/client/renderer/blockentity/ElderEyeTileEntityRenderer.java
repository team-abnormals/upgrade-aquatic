package com.teamabnormals.upgrade_aquatic.client.renderer.blockentity;

import com.teamabnormals.upgrade_aquatic.client.model.ElderEyeModel;
...
@OnlyIn(Dist.CLIENT)
public class ElderEyeTileEntityRenderer extends BlockEntityRenderer<ElderEyeBlockEntity> {
	...
	@Override
	public void render(ElderEyeBlockEntity te, float partialTicks, PoseStack matrixStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
