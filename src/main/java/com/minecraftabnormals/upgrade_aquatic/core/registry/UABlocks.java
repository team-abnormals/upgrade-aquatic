...
public class UABlocks {
	...
	public static final RegistryObject<Block> PINK_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("pink_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PINK));
	public static final RegistryObject<Block> PURPLE_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("purple_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PURPLE));
	public static final RegistryObject<Block> BLUE_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("blue_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.BLUE));
	public static final RegistryObject<Block> GREEN_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("green_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.GREEN));
	public static final RegistryObject<Block> YELLOW_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("yellow_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.YELLOW));
	public static final RegistryObject<Block> ORANGE_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("orange_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.ORANGE));
	public static final RegistryObject<Block> RED_JELLY_WALL_TORCH 		= HELPER.createBlockNoItem("red_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.RED));
	public static final RegistryObject<Block> WHITE_JELLY_WALL_TORCH 	= HELPER.createBlockNoItem("white_jelly_wall_torch", () -> new BlockJellyTorchWall(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.WHITE));

	public static final RegistryObject<Block> PINK_JELLY_TORCH 		= HELPER.createWallOrFloorBlock("pink_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PINK), PINK_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PURPLE_JELLY_TORCH 	= HELPER.createWallOrFloorBlock("purple_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.PURPLE), PURPLE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> BLUE_JELLY_TORCH 		= HELPER.createWallOrFloorBlock("blue_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.BLUE), BLUE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> GREEN_JELLY_TORCH 	= HELPER.createWallOrFloorBlock("green_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.GREEN), GREEN_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> YELLOW_JELLY_TORCH 	= HELPER.createWallOrFloorBlock("yellow_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.YELLOW), YELLOW_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> ORANGE_JELLY_TORCH 	= HELPER.createWallOrFloorBlock("orange_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.ORANGE), ORANGE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> RED_JELLY_TORCH 		= HELPER.createWallOrFloorBlock("red_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.RED), RED_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> WHITE_JELLY_TORCH 	= HELPER.createWallOrFloorBlock("white_jelly_torch", () -> new BlockJellyTorch(Properties.from(Blocks.TORCH).sound(SoundType.METAL), BlockJellyTorch.JellyTorchType.WHITE), WHITE_JELLY_WALL_TORCH, ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> BLUE_PICKERELWEED 		= HELPER.createBlock("blue_pickerelweed", () -> new BlockPickerelweed(UAProperties.PICKERELWEED), ItemGroup.MISC);
	public static final RegistryObject<Block> TALL_BLUE_PICKERELWEED 	= HELPER.createBlockNoItem("tall_blue_pickerelweed", () -> new BlockPickerelweedDouble(UAProperties.PICKERELWEED));
	public static final RegistryObject<Block> PURPLE_PICKERELWEED 		= HELPER.createBlock("purple_pickerelweed", () -> new BlockPickerelweed(UAProperties.PICKERELWEED), ItemGroup.MISC);
	public static final RegistryObject<Block> TALL_PURPLE_PICKERELWEED 	= HELPER.createBlockNoItem("tall_purple_pickerelweed", () -> new BlockPickerelweedDouble(UAProperties.PICKERELWEED));

	public static final RegistryObject<Block> WHITE_SEAROCKET 	= HELPER.createBlock("white_searocket", () -> new BlockSearocket(Effects.WATER_BREATHING, 9, UAProperties.SEAROCKET(false)), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PINK_SEAROCKET 	= HELPER.createBlock("pink_searocket", () -> new BlockSearocket(Effects.WATER_BREATHING, 9, UAProperties.SEAROCKET(true)), ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> BUBBLE_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_bubble_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.BUBBLE_CORAL, Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HORN_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_horn_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.HORN_CORAL, Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> TUBE_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_tube_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.TUBE_CORAL, Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRAIN_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_brain_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.BRAIN_CORAL, Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FIRE_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_fire_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { Blocks.FIRE_CORAL, Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ACAN_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_acan_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { ACAN_CORAL.get(), ACAN_CORAL_FAN.get(), ACAN_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FINGER_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_finger_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { FINGER_CORAL.get(), FINGER_CORAL_FAN.get(), FINGER_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STAR_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_star_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { STAR_CORAL.get(), STAR_CORAL_FAN.get(), STAR_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MOSS_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_moss_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { MOSS_CORAL.get(), MOSS_CORAL_FAN.get(), MOSS_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETAL_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_petal_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PETAL_CORAL.get(), PETAL_CORAL_FAN.get(), PETAL_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BRANCH_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_branch_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { BRANCH_CORAL.get(), BRANCH_CORAL_FAN.get(), BRANCH_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> ROCK_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_rock_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { ROCK_CORAL.get(), ROCK_CORAL_FAN.get(), ROCK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PILLOW_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_pillow_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PILLOW_CORAL.get(), PILLOW_CORAL_FAN.get(), PILLOW_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> SILK_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_silk_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { SILK_CORAL.get(), SILK_CORAL_FAN.get(), SILK_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHROME_CHISELED_CORALSTONE 			= HELPER.createBlock("chiseled_chrome_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { CHROME_CORAL.get(), CHROME_CORAL_FAN.get(), CHROME_CORAL_WALL_FAN.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PRISMARINE_CHISELED_CORALSTONE 		= HELPER.createBlock("chiseled_prismarine_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true, new Block[] { PRISMARINE_CORAL.get(), PRISMARINE_CORAL_FAN.get(), PRISMARINE_CORAL_WALL_FAN.get(), PRISMARINE_CORAL_SHOWER.get() }), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CHISELED_ELDER_PRISMARINE_CORALSTONE 	= HELPER.createBlock("chiseled_elder_prismarine_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> DEAD_CHISELED_CORALSTONE 				= HELPER.createBlock("chiseled_dead_coralstone", () -> new BlockCoralstone(UAProperties.CORALSTONE, true), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BLUE_PICKERELWEED_BLOCK 			= HELPER.createBlock("blue_pickerelweed_block", () -> new BlockPickerelweedBlock(UAProperties.PICKERELWEED_BLOCK(false), false), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PURPLE_PICKERELWEED_BLOCK 		= HELPER.createBlock("purple_pickerelweed_block", () -> new BlockPickerelweedBlock(UAProperties.PICKERELWEED_BLOCK(false), false), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BOILED_BLUE_PICKERELWEED_BLOCK 	= HELPER.createBlock("boiled_blue_pickerelweed_block", () -> new BlockPickerelweedBlock(UAProperties.PICKERELWEED_BLOCK(true), true), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> BOILED_PURPLE_PICKERELWEED_BLOCK 	= HELPER.createBlock("boiled_purple_pickerelweed_block", () -> new BlockPickerelweedBlock(UAProperties.PICKERELWEED_BLOCK(true), true), ItemGroup.BUILDING_BLOCKS);
