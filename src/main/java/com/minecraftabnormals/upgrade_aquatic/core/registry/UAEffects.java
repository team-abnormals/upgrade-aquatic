...
public class UAEffects {
	...
	public static final RegistryObject<MobEffect> INSOMNIA = MOB_EFFECTS.register("insomnia", InsomniaEffect::new);
	public static final RegistryObject<MobEffect> RESTFULNESS = MOB_EFFECTS.register("restfulness", RestfulnessEffect::new);
	public static final RegistryObject<MobEffect> REPELLENCE = MOB_EFFECTS.register("repellence", RepellenceEffect::new);
	public static final RegistryObject<MobEffect> VIBING = MOB_EFFECTS.register("vibing", VibingEffect::new);
