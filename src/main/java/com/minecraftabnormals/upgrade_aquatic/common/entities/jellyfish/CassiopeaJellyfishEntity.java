 ...
 */
public class CassiopeaJellyfishEntity extends AbstractJellyfishEntity {
	public static final DataParameter<Integer> COLOR = EntityDataManager.createKey(CassiopeaJellyfishEntity.class, DataSerializers.VARINT);
	public static final DataParameter<Float> SIZE = EntityDataManager.createKey(CassiopeaJellyfishEntity.class, DataSerializers.FLOAT);
