...
public class NautilusModel<T extends NautilusEntity> extends EntityModel<T> {
    ...
    public void setupAnim(T nautilus, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.tents_left.yRot = -shellSway * 0.10F * MathHelper.cos(0.2F * ageInTicks);
        this.tents_right.yRot = -shellSway * 0.10F * -MathHelper.cos(0.2F * ageInTicks);
        this.tents_top.xRot = -shellSway * 0.10F * MathHelper.sin(0.2F * ageInTicks);
        this.tents_bottom.xRot = -shellSway * 0.10F * -MathHelper.sin(0.2F * ageInTicks);
        
        if(moving && nautilus.isInWater()) {
        	this.shell.xRot = -1.0F * 0.12F * MathHelper.sin(0.2F * ageInTicks);
        }
    }
